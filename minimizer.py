...
class Minimizer:
	...
	def __init__(self, objective_func, initial_population, max_values, exercises):
	...
	def run(self, gen_count, mutation_rate=0.1, crossover_rate=0.8, verbose=-1):
	...
	def __individuals_evaluation(self):
		return [self.objective_func(individual, self.exercises, self.max_values) for individual in self.population]
